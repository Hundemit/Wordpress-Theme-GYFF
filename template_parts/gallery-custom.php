...
<div id="controls-carousel" class="relative w-full h-44 sm:h-72 !mt-0 md:h-80 lg:h-96 duration-700 mb-5 imgShadow"
    ...
    <button type="button"
        ...
        data-carousel-prev>
        <span
            class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-500 group-hover:bg-gray-200  group-focus:ring-4 group-focus:ring-white  group-focus:outline-none">
