...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_bloginfo('template_url'); ?>/css/single.css">
    <!--  --> <?php wp_head(); ?>
</head>
    ...
    <header class="fixed z-50 backdrop-blur-2xl top-0 w-screen" x-data="{ mobileMenu: false }">
        <nav class="mx-auto flex container items-center justify-between p-6 duration-200 backdrop-blur-lg"
            ...
            <div id="buttonContainer" class="lg:order-3 flex">
                <a id="joinWaitListButton" href="<?php echo home_url(); ?>#phone"
                    class="inline-flex mr-4 lg:mr-0 items-center px-5 py-2.5 text-base font-medium text-center text-white bg-gradient-to-br from-darkGreen to-lightGreen rounded-lg focus:ring-4 focus:outline-none focus:ring-darkGreen">
                    <span
            ...
            <div id="desktopMenuButtons" class="hidden lg:flex md:gap-x-12">
                <a href="<?php echo home_url(); ?>/#aktienanalyse"
                    class="text-lg font-normal leading-6 text-white">Aktienanalyse</a>
                <a href="<?php echo home_url(); ?>/#aktienscreener"
                    class="text-lg font-normal leading-6 text-white">Aktienscreener</a>
                <a href="<?php echo home_url(); ?>/#unternehmen"
                    class="text-lg font-normal leading-6 text-white">Unternehmen</a>
                <a href="<?php echo home_url(); ?>/#kontakt"
                    class="text-lg font-normal leading-6 text-white">Kontakt</a>
            ...
            <div
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        ...
                        <div class="py-6">
                            <a @click="mobileMenu = !mobileMenu" id="joinWaitListButton"
                                href="<?php echo home_url(); ?>#phone"
                                class="inline-flex w-full justify-center mr-4 lg:mr-0 items-center px-5 py-2.5 text-base font-medium text-center text-white bg-gradient-to-br from-darkGreen to-lightGreen rounded-lg focus:ring-4 focus:outline-none focus:ring-darkGreen">
                                <span
                                    class="inline-flex items-center justify-center w-4 h-4 mr-2 text-xs font-semibold text-white rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#dddddd"
                                        viewBox="0 0 256 256">
